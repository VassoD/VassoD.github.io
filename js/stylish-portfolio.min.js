...
document.querySelector(".nightmode").addEventListener("click", () => {
  ...
  // Get a reference to the <div> element you want to change the color of
  const myDiv = document.getElementById("timelinediv");

  // If night mode is enabled, change the color of the <div> element
  if (document.querySelector("body").classList.contains("dark")) {
   //change text color 
    myDiv.style.color = "#fff !important"; // set the text color to white
  }
});
